...
//D2Common.0x6FD83D20
void DRLGOUTROOM_FreeDrlgOutdoorRoom(struct D2DrlgRoom* pDrlgRoom)
{
...
//D2Common.0x6FD83D90
void DRLGOUTROOM_FreeDrlgOutdoorRoomData(struct D2DrlgRoom* pDrlgRoom)
{
	if (pDrlgRoom->pOutdoor)
	{
...
//D2Common.0x6FD83DE0
void DRLGOUTROOM_AllocDrlgOutdoorRoom(struct D2DrlgRoom* pDrlgRoom)
{
	pDrlgRoom->pOutdoor = D2_CALLOC_STRC_POOL(pDrlgRoom->pLevel->pDrlg->pMempool, struct D2DrlgOutdoorRoom);
}

//D2Common.6FD83E20
void DRLGOUTROOM_InitializeDrlgOutdoorRoom(struct D2DrlgRoom* pDrlgRoom)
{
...
//D2Common.0x6FD83EC0
BOOL DRLGOUTROOM_LinkLevelsByLevelCoords(struct D2DrlgLevelLinkData* pLevelLinkData)
{
...
//D2Common.0x6FD83F70
BOOL DRLGOUTROOM_LinkLevelsByLevelDef(struct D2DrlgLevelLinkData* pLevelLinkData)
{
...
//D2Common.0x6FD84010
BOOL DRLGOUTROOM_LinkLevelsByOffsetCoords(struct D2DrlgLevelLinkData* pLevelLinkData)
{
