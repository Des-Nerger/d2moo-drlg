...
void __cdecl DATATBLS_LoadArenaTxt(HD2ARCHIVE hArchive)
{
	...
	gpArenaTxtTable = (struct D2ArenaTxt*)DATATBLS_CompileTxt(hArchive, "arena", pTbl, NULL, sizeof(struct D2ArenaTxt));
}
...
void __cdecl DATATBLS_LoadCharTemplateTxt(HD2ARCHIVE hArchive)
{
	...
	gpCharTemplateTxtTable = (struct D2CharTemplateTxt*)DATATBLS_CompileTxt(hArchive, "chartemplate", pTbl, &gnCharTemplateTxtTableRecordCount, sizeof(struct D2CharTemplateTxt));
