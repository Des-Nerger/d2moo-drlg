...
{
	char szName[64];						//0x00
	struct Unicode wszName[64];					//0x40
	char szToken[3];						//0xC0
...
//D2Common.0x6FD6FDF0
void DATATBLS_LoadObjectsTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD718F0 (#10626)
D2COMMON_DLL_DECL struct D2ObjectsTxt* DATATBLS_GetObjectsTxtRecord(int nObjectId);
//D2Common.0x6FD71960
void DATATBLS_UnloadObjectsTxt();
//D2Common.0x6FD71980
void DATATBLS_UnloadObjGroupTxt();
//D2Common.0x6FD719A0
void DATATBLS_LoadObjGroupTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD71E00 (#10627)
D2COMMON_DLL_DECL struct D2ObjGroupTxt* DATATBLS_GetObjGroupTxtRecord(int nId);
//D2Common.0x6FD71E30
void DATATBLS_LoadShrinesTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD72000 (#10624)
D2COMMON_DLL_DECL struct D2ShrinesTxt* DATATBLS_GetShrinesTxtRecord(int nShrineId);
//D2Common.0x6FD72070 (#10625)
D2COMMON_DLL_DECL int DATATBLS_GetShrinesTxtRecordCount();
//D2Common.0x6FD72080
void DATATBLS_UnloadShrinesTxt();
