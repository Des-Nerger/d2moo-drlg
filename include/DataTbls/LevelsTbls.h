...
struct D2AutomapRand
{
	int32_t nStart;						//0x00
	int32_t nEnd;						//0x04
};

struct D2AutomapShort
{
...
struct D2LevelsTxt
{
	...
	struct Unicode wszLevelName[40];			//0x16E
	struct Unicode wszLevelWarp[40];			//0x1BE
...
struct D2LvlSubTxt
{
	...
	struct D2DrlgFile* pDrlgFile;				//0x50
	struct D2DrlgGrid pTileTypeGrid[4];		//0x54
	struct D2DrlgGrid pWallGrid[4];			//0xA4
	struct D2DrlgGrid pFloorGrid;				//0xF4
	struct D2DrlgGrid pShadowGrid;				//0x108
...
//D2Common.0x6FD5EAE0
void DATATBLS_LoadLevelsTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD603C0 (#10631)
D2COMMON_DLL_DECL struct D2LevelsTxt* DATATBLS_GetLevelsTxtRecord(int nLevelId);
//D2Common.0x6FD603F0 (#10632)
D2COMMON_DLL_DECL uint8_t DATATBLS_GetRainFromLevelsTxt(int nLevelId);
//D2Common.0x6FD60430 (#10634)
D2COMMON_DLL_DECL uint8_t DATATBLS_GetNoPerFromLevelsTxt(int nLevelId);
//D2Common.0x6FD60470 (#10633)
D2COMMON_DLL_DECL uint8_t DATATBLS_GetMudFromLevelsTxt(int nLevelId);
//D2Common.0x6FD604B0
void DATATBLS_UnloadLevelsTxt();
//D2Common.0x6FD604F0 (#11247)
D2COMMON_DLL_DECL int DATATBLS_GetMonsterLevelInArea(int nLevelId, uint8_t nDifficulty, BOOL bExpansion);
//D2Common.0x6FD60560
int* DATATBLS_GetPortalLevels(int* pnPortalLevels);
//D2Common.0x6FD60570
void DATATBLS_LoadLevelDefsBin(HD2ARCHIVE hArchive);
//D2Common.0x6FD60D60
void DATATBLS_UnloadLevelDefsBin();
//D2Common.0x6FD60D90 (#10010)
D2COMMON_DLL_DECL struct D2LevelDefBin* DATATBLS_GetLevelDefRecord(int nLevelId);
//D2Common.0x6FD60DC0
void DATATBLS_LoadLevelTypesTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD61450
void DATATBLS_UnloadLevelTypesTxt();
//D2Common.0x6FD61460 (#10023)
D2COMMON_DLL_DECL struct D2LvlTypesTxt* DATATBLS_GetLevelTypesTxtRecord(int nLevelType);
//D2Common.0x6FD614A0 (#11226)
D2COMMON_DLL_DECL bool DATATBLS_CheckActInLevelTypesTxt(int nLevelType, uint8_t nAct);
//D2Common.0x6FD61500 (#11227)
D2COMMON_DLL_DECL void DATATBLS_GetFileNameFromLevelTypeAndFileId(int nLevelType, int nFile, char* szFile);
//D2Common.0x6FD61570
void DATATBLS_LoadLvlPrestTxt(HD2ARCHIVE hArchive, int a2);
//D2Common.0x6FD61AD0
void DATATBLS_UnloadLvlPrestTxt();
//D2Common.0x6FD61B50 (#10024)
D2COMMON_DLL_DECL struct D2LvlPrestTxt* DATATBLS_GetLvlPrestTxtRecord(int nId);
//D2Common.0x6FD61B80
struct D2LvlPrestTxt* DATATBLS_GetLvlPrestTxtRecordFromLevelId(int nLevelId);
//D2Common.0x6FD61BC0
void DATATBLS_LoadLvlWarpTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD61DD0
void DATATBLS_UnloadLvlWarpTxt();
//D2Common.0x6FD61DE0
struct D2LvlWarpTxt* DATATBLS_GetLvlWarpTxtRecordFromLevelIdAndDirection(int nLevelId, char szDirection);
//D2Common.0x6FD61E60
void DATATBLS_LoadLvlMazeTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD61F90
void DATATBLS_UnloadLvlMazeTxt();
//D2Common.0x6FD61FA0
struct D2LvlMazeTxt* DATATBLS_GetLvlMazeTxtRecordFromLevelId(int nLevelId);
//D2Common.0x6FD62020
void DATATBLS_LoadLvlSubTxt(HD2ARCHIVE hArchive, int a2, int a3);
//D2Common.0x6FD62600
void DATATBLS_UnloadLvlSubTxt();
//D2Common.0x6FD626F0
struct D2LvlSubTxt* DATATBLS_GetLvlSubTxtRecord(int nSubType);
//D2Common.0x6FD62780
void DATATBLS_AllocGlobalTileLibraryHash();
//D2Common.0x6FD628A0
void DATATBLS_FreeGlobalTileLibraryHash();
//D2Common.0x6FD628C0
void DATATBLS_LoadAutomapTxt(HD2ARCHIVE hArchive);
//D2Common.0x6FD62D30 (#10011)
D2COMMON_DLL_DECL int DATATBLS_GetAutomapCellId(uint32_t dwAutomapLevelType, uint32_t dwAutomapTileType, int nStyle, int nSequence);
//D2Common.0x6FD62E70
void DATATBLS_FreeAutomap();
