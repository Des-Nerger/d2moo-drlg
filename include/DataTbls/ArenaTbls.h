...
D2COMMON_DLL_DECL struct D2ArenaTxt* __cdecl DATATBLS_GetArenaTxtRecord(int nArenaType);
//D2Common.0x6FD479B0
...
D2COMMON_DLL_DECL int __cdecl DATATBLS_GetCharTemplateTxtRecordCount();
//D2Common.0x6FD487A0 (#10665)
D2COMMON_DLL_DECL struct D2CharTemplateTxt* __cdecl DATATBLS_GetCharTemplateTxtRecord(int nTemplate, int nLevel);
//D2Common.0x6FD48810 (#10666)
D2COMMON_DLL_DECL int __cdecl DATATBLS_GetClassFromCharTemplateTxtRecord(int nTemplate, int nLevel);
