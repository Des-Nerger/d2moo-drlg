...
//Helper function
inline bool DRLGMAZE_HasMapDS1(struct D2DrlgRoom* pDrlgRoom)
{
	return pDrlgRoom->pMaze->nFlags & DRLGPRESETROOMFLAG_HAS_MAP_DS1;
}

//D2Common.0x6FD859A0 (#11222)
D2COMMON_DLL_DECL int __cdecl DRLGPRESET_CountPresetObjectsByAct(uint8_t nAct);
//D2Common.0x6FD859E0 (#11223)
D2COMMON_DLL_DECL int __cdecl DRLGPRESET_GetObjectIndexFromObjPreset(uint8_t nAct, int nUnitId);
//D2Common.0x6FD85A10
...
D2COMMON_DLL_DECL struct D2MapAI* __cdecl DRLGPRESET_CreateCopyOfMapAI(void* pMemPool, struct D2MapAI* pMapAI);
//D2Common.0x6FD864F0 (#10021)
D2COMMON_DLL_DECL struct D2MapAI* __cdecl DRLGPRESET_ChangeMapAI(struct D2MapAI** ppMapAI1, struct D2MapAI** ppMapAI2);
//D2Common.0x6FD86500 (#10022)
D2COMMON_DLL_DECL void __cdecl DRLGPRESET_FreeMapAI(void* pMemPool, struct D2MapAI* pMapAI);
//D2Common.0x6FD86540
...
D2COMMON_DLL_DECL int __cdecl DRLGPRESET_GetLevelPrestIdFromRoomEx(struct D2DrlgRoom* pDrlgRoom);
//D2Common.0x6FD881B0 (#10009)
D2COMMON_DLL_DECL char* __cdecl DRLGPRESET_GetPickedLevelPrestFilePathFromRoomEx(struct D2DrlgRoom* pDrlgRoom);
//D2Common.0x6FD881D0
