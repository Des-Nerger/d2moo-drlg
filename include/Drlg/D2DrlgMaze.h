...
//D2Common.0x6FD78E50
struct D2DrlgRoom* __fastcall sub_6FD78E50(struct D2DrlgLevel* pLevel);
//D2Common.0x6FD78F70
void __fastcall DRLGMAZE_PickRoomPreset(struct D2DrlgRoom* pDrlgRoom, BOOL bResetFlag);
//D2Common.0x6FD79240
struct D2DrlgRoom* __fastcall sub_6FD79240(struct D2DrlgLevel* pLevel);
//D2Common.0x6FD79360
struct D2DrlgRoom* __fastcall sub_6FD79360(struct D2DrlgLevel* pLevel);
//D2Common.0x6FD79480
...
//D2Common.0x6FD79EA0
struct D2DrlgRoom* __fastcall DRLGMAZE_AddAdjacentMazeRoom(struct D2DrlgRoom* pDrlgRoom, int nDirection, int bMergeRooms);
//D2Common.0x6FD7A110
...
//D2Common.0x6FD7AFD0
struct D2DrlgRoom* __fastcall DRLGMAZE_PlaceAdjacentPresetRoom(struct D2DrlgRoom* pParentRoomEx, int nDirection, int bMergeRooms);
//D2Common.0x6FD7B230
...
//D2Common.0x6FD7BC40
struct D2DrlgRoom* __fastcall DRLGMAZE_InitRoomFixedPreset(struct D2DrlgRoom* pDrlgRoom, int nDirection, int nLvlPrestId, int nFile, int bUseInitPreset);
//D2Common.0x6FD7BCD0
