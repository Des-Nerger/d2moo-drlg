...
typedef BOOL(__fastcall* PROPERTYASSIGN)(int32_t, struct D2Unit*, struct D2Unit*, const struct D2Property*, int32_t, int32_t, int32_t, int32_t, struct D2Unit*);

typedef int32_t(__fastcall* PROPERTYASSIGNFN)(int32_t, struct D2Unit*, struct D2Unit*, const struct D2Property*, int32_t, int16_t, int32_t, int32_t, int32_t, int32_t, struct D2Unit*);
...
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_GetItemCharges(struct D2Unit* pItem, int nSkillId, int nSkillLevel, int* pValue, struct D2StatList** ppStatList);
//D2Common.0x6FD927D0 (#10847)
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_UpdateItemWithSkillCharges(struct D2Unit* pItem, int nSkillId, int nSkillLevel, int a4);
...
D2COMMON_DLL_DECL void __stdcall ITEMMODS_AssignProperty(int nType, struct D2Unit* a2, struct D2Unit* pItem, const void* pMods, int nPropSet, int nApplyType);
//D2Common.0x6FD95810
...
D2COMMON_DLL_DECL void __stdcall ITEMMODS_ApplyEthereality(struct D2Unit* pItem);
//D2Common.0x6FD959F0 (#10867)
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_UpdateRuneword(struct D2Unit* pUnit, struct D2Unit* pItem, int nUnused);
//D2Common.0x6FD95A70
void __fastcall ITEMMODS_UpdateFullSetBoni(struct D2Unit* pUnit, struct D2Unit* pItem, int nState);
//D2Common.0x6FD95BE0 (#10859)
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_CanItemHaveMagicAffix(struct D2Unit* pItem, const struct D2MagicAffixTxt* pMagicAffixTxtRecord);
//D2Common.0x6FD95CC0 (#10860)
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_CanItemHaveRareAffix(struct D2Unit* pItem, struct D2RareAffixTxt* pRareAffixTxtRecord);
//D2Common.0x6FD95D60 (#10861)
D2COMMON_DLL_DECL BOOL __stdcall ITEMMODS_CanItemBeHighQuality(struct D2Unit* pItem, struct D2QualityItemsTxt* pQualityItemsTxtRecord);
//D2Common.0x6FD95E90 (#10862)
D2COMMON_DLL_DECL void __stdcall ITEMMODS_SetRandomElixirFileIndex(struct D2Unit* pItem);
//D2Common.0x6FD95F90 (#10868)
D2COMMON_DLL_DECL void __stdcall ITEMMODS_AddCraftPropertyList(struct D2Unit* pItem, struct D2Property* pProperty, int nUnused);
//D2Common.0x6FD95FC0
...
D2COMMON_DLL_DECL void __stdcall D2COMMON_11292_ItemAssignProperty(int nType, struct D2Unit* pUnit, struct D2Unit* pItem, const void* pMods, int nIndex, int nPropSet, const struct D2Property* pProperty, int nState, int fStatlist, struct D2Unit* a10);
//D2Common.0x6FD98220
...
D2COMMON_DLL_DECL int __stdcall ITEMMODS_EvaluateItemFormula(struct D2Unit* pUnit, struct D2Unit* pItem, unsigned int nCalc);
