...
D2COMMON_DLL_DECL BOOL __stdcall D2Common_10230(struct D2DynamicPath* pDynamicPath, int a2, struct D2ActiveRoom* pRoom, unsigned int a4, __int16 a5);
//1.00:  D2Common.0x10060120 (#10228)
//1.10f: D2Common.0x6FDADC20 (#10231)
D2COMMON_DLL_DECL int __stdcall D2Common_10231(struct D2DynamicPath* pDynamicPath, struct D2Unit* pUnit_unused, struct D2ActiveRoom* pRooms, uint16_t nX, uint16_t nY);
//1.00:  D2Common.0x100606B0 (#10229)
//1.10f: D2Common.0x6FDADF50 (#10232)
//1.13c: D2Common.0x6FD5DCE0 (#10223)
D2COMMON_DLL_DECL BOOL __stdcall D2Common_10232(struct D2DynamicPath* pPath, struct D2Unit* pUnit, struct D2ActiveRoom* pDestRoom, int nTargetX, int nTargetY);
//1.00:  D2Common.0x10060A60 (#10230)
//1.10f: D2Common.0x6FDAE290 (#10233)
//1.13c: D2Common.0x6FD5DB40 (#10770)
D2COMMON_DLL_DECL void __stdcall PATH_RecacheRoomIfNeeded(struct D2DynamicPath* pDynamicPath);
//1.00:  D2Common.0x10060C40 (#10231)
//1.10f: D2Common.0x6FDAE500 (#10234)
D2COMMON_DLL_DECL BOOL __stdcall D2Common_10234(struct D2DynamicPath* pDynamicPath);
//1.00:  D2Common.0x10060C60 (#10231)
//1.10f: D2Common.0x6FDAE520 (#10235)
D2COMMON_DLL_DECL void __stdcall D2Common_10235_PATH_UpdateRiderPath(struct D2Unit* pRiderUnit, struct D2Unit* pMountUnit);
