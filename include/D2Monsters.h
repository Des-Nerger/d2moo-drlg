...
D2COMMON_DLL_DECL int __fastcall MONSTERS_HirelingInit(BOOL bExpansion, struct D2Unit* pMonster, int nLowSeed, int nAct, int nDifficulty, struct D2HirelingInit* pHirelingInit);
//D2Common.0x6FDA4E20 (#11081)
D2COMMON_DLL_DECL BOOL __fastcall D2Common_11081(int nLowSeed, struct D2HirelingInit* pHirelingInit, uint8_t a3);
//D2Common.0x6FDA51A0 (#11085)
D2COMMON_DLL_DECL const struct Unicode* __fastcall MONSTERS_GetHirelingDescString(int nId);
...
D2COMMON_DLL_DECL int __stdcall MONSTERS_GetHirelingResurrectionCost(struct D2Unit* pHireling);
//D2Common.0x6FDA5270 (#11068)
D2COMMON_DLL_DECL int __stdcall D2COMMON_11068_GetCompInfo(struct D2Unit* pMonster, int nComponent);
//D2Common.0x6FDA52F0 (#11069)
D2COMMON_DLL_DECL uint32_t __stdcall D2Common_11069(struct D2Unit* pMonster, unsigned int nIndex, unsigned int nComponent);
...
D2COMMON_DLL_DECL int __stdcall D2Common_11050(struct D2Unit* pUnit, int a2);
...
D2COMMON_DLL_DECL void __fastcall MONSTERS_SetMonsterNameInMonsterData(struct D2Unit* pMonster, const struct Unicode* wszName);
//D2Common.0x6FDA56C0
BOOL __fastcall MONSTERS_CanBeInTown(struct D2Unit* pMonster);
//D2Common.0x6FDA5750 (#11057)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsSandLeaper(struct D2Unit* pMonster, BOOL bAlwaysReturnFalse);
//D2Common.0x6FDA57D0 (#11058)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsDemon(struct D2Unit* pMonster);
//D2Common.0x6FDA5830 (#11059)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsUndead(struct D2Unit* pMonster);
//D2Common.0x6FDA58A0 (#11060)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsBoss(struct D2MonStatsTxt* pMonStatsTxtRecord, struct D2Unit* pMonster);
//D2Common.0x6FDA5900 (#11064)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsDead(struct D2Unit* pMonster);
//D2Common.0x6FDA5930 (#11280)
D2COMMON_DLL_DECL int __stdcall MONSTERS_GetSpawnMode_XY(struct D2Unit* pMonster, BOOL bFromMonster, int nSkillId, int nSkillLevel, int* pSpawnMode, int* pX, int* pY);
//D2Common.0x6FDA5B30 (#11061)
D2COMMON_DLL_DECL void __stdcall MONSTERS_GetMinionSpawnInfo(struct D2Unit* pMonster, int* pId, int* pX, int* pY, int* pSpawnMode, int nDifficulty, int(__fastcall* pfSpawnClassCallback)(struct D2Unit*));
//D2Common.0x6FDA6410 (#11051)
D2COMMON_DLL_DECL uint8_t __stdcall MONSTERS_GetMaximalLightRadius(struct D2Unit* pMonster);
//D2Common.0x6FDA64B0 (#11063)
D2COMMON_DLL_DECL int __stdcall D2Common_11063(struct D2ActiveRoom* pRoom, int nMonsterId);
//D2Common.0x6FDA6620 (#11065)
D2COMMON_DLL_DECL BOOL __stdcall MONSTERS_IsPrimeEvil(struct D2Unit* pMonster);
//D2Common.0x6FDA6680 (#11066)
D2COMMON_DLL_DECL void __stdcall D2Common_11066(struct D2Unit* pMonster, int* pDirectionX, int* pDirectionY);
//D2Common.0x6FDA6730 (#11067)
D2COMMON_DLL_DECL int __stdcall MONSTERS_GetHirelingTypeId(struct D2Unit* pHireling);
//D2Common.0x6FDA6790 (#11246)
D2COMMON_DLL_DECL void __stdcall MONSTERS_ApplyClassicScaling(struct D2Unit* pMonster, BOOL bExpansion, uint8_t nDifficulty);
//D2Common.0x6FDA6920
