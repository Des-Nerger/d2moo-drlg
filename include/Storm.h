...
/// Not imported by any .dll
typedef int(__fastcall* SNetEnumGamesEx_Callback)(DWORD, DWORD, DWORD);
...
/// Imported by ['D2Win.dll', 'D2Client.dll']
D2FUNC_DLL_NP(STORM, SMsgBreakHandlerChain, BOOL, __stdcall, (struct SMSGHANDLER_PARAMS* pData), 0x1d110);  //Storm.#511
