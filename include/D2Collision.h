...
D2COMMON_DLL_DECL uint16_t __stdcall COLLISION_CheckMask(struct D2ActiveRoom* pRoom, int nX, int nY, uint16_t nMask);
//D2Common.0x6FD41720 (#10127)
D2COMMON_DLL_DECL void __stdcall COLLISION_SetMask(struct D2ActiveRoom* pRoom, int nX, int nY, uint16_t nMask);
//D2Common.0x6FD417F0 (#10123)
D2COMMON_DLL_DECL void __stdcall COLLISION_ResetMask(struct D2ActiveRoom* pRoom, int nX, int nY, uint16_t nMask);
//D2Common.0x6FD418C0 (#10120)
D2COMMON_DLL_DECL uint16_t __stdcall COLLISION_CheckMaskWithSizeXY(struct D2ActiveRoom* pRoom, int nX, int nY, unsigned int nSizeX, unsigned int nSizeY, uint16_t nMask);
//D2Common.0x6FD41B40
...
D2COMMON_DLL_DECL uint16_t __stdcall COLLISION_CheckMaskWithPattern(struct D2ActiveRoom* pRoom, int nX, int nY, int nCollisionPattern, uint16_t nMask);
//D2Common.0x6FD42000
...
D2COMMON_DLL_DECL int __stdcall COLLISION_CheckAnyCollisionWithPattern(struct D2ActiveRoom* pRoom, int nX, int nY, int nCollisionPattern, uint16_t nMask);
//D2Common.0x6FD428D0
...
D2COMMON_DLL_DECL uint16_t __stdcall COLLISION_CheckMaskWithSize(struct D2ActiveRoom* pRoom, int nX, int nY, int nUnitSize, uint16_t nMask);
//D2Common.0x6FD432A0 (#10128)
D2COMMON_DLL_DECL void __stdcall COLLISION_SetMaskWithSize(struct D2ActiveRoom* pRoom, int nX, int nY, int nUnitSize, uint16_t nMask);
//D2Common.0x6FD434B0
...
D2COMMON_DLL_DECL void __stdcall COLLISION_SetMaskWithPattern(struct D2ActiveRoom* pRoom, int nX, int nY, int nCollisionPattern, uint16_t nMask);
//D2Common.0x6FD439D0 (#10124)
D2COMMON_DLL_DECL void __stdcall COLLISION_ResetMaskWithSize(struct D2ActiveRoom* pRoom, int nX, int nY, int nUnitSize, uint16_t nMask);
//D2Common.0x6FD43C10
...
D2COMMON_DLL_DECL void __stdcall COLLISION_ResetMaskWithPattern(struct D2ActiveRoom* pRoom, int nX, int nY, int nCollisionPattern, uint16_t nMask);
//D2Common.0x6FD44140 (#10125)
D2COMMON_DLL_DECL void __stdcall COLLISION_ResetMaskWithSizeXY(struct D2ActiveRoom* pRoom, int nX, int nY, unsigned int nSizeX, unsigned int nSizeY, uint16_t nMask);
//D2Common.0x6FD44370
...
D2COMMON_DLL_DECL void __stdcall COLLISION_SetMaskWithSizeXY(struct D2ActiveRoom* pRoom, int nX, int nY, unsigned int nSizeX, unsigned int nSizeY, uint16_t nMask);
//D2Common.0x6FD44600
...
D2COMMON_DLL_DECL uint16_t __fastcall COLLISION_TryMoveUnitCollisionMask(struct D2ActiveRoom* pRoom, int nX1, int nY1, int nX2, int nY2, int nUnitSize, uint16_t nCollisionMask, uint16_t nMoveConditionMask);
//D2Common.0x6FD44910
...
D2COMMON_DLL_DECL uint16_t __fastcall COLLISION_TryTeleportUnitCollisionMask(struct D2ActiveRoom* pRoom, int nX1, int nY1, int nX2, int nY2, int nCollisionPattern, uint16_t nFootprintCollisionMask, uint16_t nMoveConditionMask);
//D2Common.0x6FD44BB0
...
D2COMMON_DLL_DECL void __fastcall COLLISION_SetUnitCollisionMask(struct D2ActiveRoom* pRoom1, int nX1, int nY1, struct D2ActiveRoom* pRoom2, int nX2, int nY2, int nCollisionPattern, uint16_t nCollisionMask);
//D2Common.0x6FD45210 (#11263)
//Returns true if a collision with mask was found. pEndCoord will be set to the collision location.
D2COMMON_DLL_DECL BOOL __stdcall COLLISION_RayTrace(struct D2ActiveRoom* pRoom, struct D2Coord* pBeginCoord, struct D2Coord* pEndCoord, uint16_t nCollisionMask);
//D2Common.0x6FD459D0 (#10135)
D2COMMON_DLL_DECL struct D2ActiveRoom* __stdcall COLLISION_GetFreeCoordinatesWithMaxDistance(struct D2ActiveRoom* pRoom, struct D2Coord* pSpawnPoint, int nUnitSize, unsigned int nMask, BOOL bAllowNeighborRooms, int nMaxDistance);
//D2Common.0x6FD45A00
...
D2COMMON_DLL_DECL struct D2ActiveRoom* __stdcall COLLISION_GetFreeCoordinates(struct D2ActiveRoom* pRoom, struct D2Coord* pSpawnPoint, int nUnitSize, unsigned int nMask, BOOL bAllowNeighborRooms);
//D2Common.0x6FD462B0 (#10137)
D2COMMON_DLL_DECL struct D2ActiveRoom* __stdcall COLLISION_GetFreeCoordinatesEx(struct D2ActiveRoom* pRoom, struct D2Coord* pSpawnPoint, int nUnitSize, unsigned int nMask, int nPosIncrementValue);
//D2Common.0x6FD462E0 (#10138)
D2COMMON_DLL_DECL struct D2ActiveRoom* __stdcall COLLISION_GetFreeCoordinatesWithField(struct D2ActiveRoom* pRoom, struct D2Coord* pSpawnPoint, struct D2Coord* pFieldCoord, int nUnitSize, unsigned int nMask, unsigned int nFieldMask, BOOL bAllowNeighborRooms);
//D2Common.0x6FD46310 (#10136)
D2COMMON_DLL_DECL void __fastcall D2Common_10136(struct D2ActiveRoom* pRoom, struct D2Coord* pCoord, int a3, uint16_t nMask, struct D2ActiveRoom** ppRoom);
//D2Common.0x6FD46620
